...
if ($count != '0') {
    while ($row = mysqli_fetch_array($query)) {
        ...
        <div class='topic-file'>
                ...
                <i class='fal fa-solid fa-ellipsis-h user-view' onclick='toggleVideoDropdown("; echo $file_id; echo ")'></i>
                <div class='file-dropdown'>
                    <div id='video_ID";echo $file_id; echo"' class='file-dropdown-content'>
                        <span id='delete-file-btn' class='file-dropdown-box' data-id='"; echo $file_id; echo "' onclick='deleteVideo("; echo $file_id; echo ")'>
                            <span>Delete</span>
